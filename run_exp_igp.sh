...
python train_igp.py --exp_name unet_c16_is1dlis10_more --options net.c0=16,net.i_s_weight=1,,dataloader.i_s_weight=10
# python train_igp.py --exp_name unet_c16_is1_dlis1_more --options net.c0=16,net.i_s_weight=1,dataloader.i_s_weight=1
